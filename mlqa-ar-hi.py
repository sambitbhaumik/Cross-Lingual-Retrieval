...
dataset = load_dataset("mlqa", "mlqa.hi.ar")
df = load_dataset("mlqa", "mlqa.hi.hi")
...
"""
with open("tfidf-ar-hi.json", "r") as file:
    tfidf_candidate_passages = json.load(file)

with open("bm25-ar-hi.json", "r") as file:
    bm25_candidate_passages = json.load(file)

with open("randomed-ar-hi.json", "r") as file:
